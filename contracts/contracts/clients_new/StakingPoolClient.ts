...
export class StakingPoolClient {
  ...
  state = {
    ...
    global: {
       ...
       */
      algodVer: async (): Promise<Uint8Array | undefined> => { return (await this.appClient.state.global.getValue("algodVer")) as Uint8Array | undefined },
      /**
